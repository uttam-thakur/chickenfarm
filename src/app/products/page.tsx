...
export const metadata = {
  ...
  description: "Browse our selection of farm-fresh chicken products. From whole chickens to specialty cuts, we offer the highest quality poultry raised on our farm.",
};
    ...
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-3xl mx-auto text-center mb-16">
        ...
        <p className="text-gray-600">
          All our products come from chickens raised on our family-owned farm. Our birds are fed a natural diet, given room to roam freely, and never administered antibiotics or hormones.
        </p>
      </div>
      ...
      <section className="mb-16">
          ...
          {products.map((product) => (
            <div key={product.id} className="bg-white rounded-lg shadow-sm overflow-hidden flex flex-col">
              ...
              <div className="p-4 flex flex-col flex-grow">
                <h3 className="text-xl font-bold text-[#B23F00]">{product.name}</h3>
                <p className="text-gray-500 text-sm mt-1">{product.description}</p>
                <div className="mt-auto pt-4">
                  <p className="text-lg font-bold text-[#E85D04] mb-3">${product.price.toFixed(2)} / {product.unit}</p>
        ...
        <div className="text-center mt-12">
          <Button variant="outline" className="border-[#E85D04] text-[#E85D04] hover:bg-orange-50">
            View All Products
          </Button>
        </div>
      </section>
      ...
      <section className="mb-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-[#B23F00] mb-4">Shop by Category</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
      ...
      <section className="bg-[#FFF8F0] p-8 rounded-xl">
        <div className="flex flex-col md:flex-row gap-8 items-center">
          <div className="flex-1">
            <h2 className="text-2xl font-bold text-[#B23F00] mb-4">Looking for Bulk Orders?</h2>
            <p className="text-gray-600 mb-6">
              We offer special pricing for bulk orders for restaurants, markets, and large events.
...
const categories = [
  ...
  },
  {
    id: "chicken-cuts",
    name: "Chicken Cuts",
    image: "https://marvel-b1-cdn.bc0a.com/f00000000202513/www.fosterfarms.com/wp-content/uploads/557-7569-451012-RTC-CON-BRSTTNDRSBLSL-3D_H.png",
  },
  {
    id: "eggs",
  ...
  },
  {
    id: "special-packs",
    name: "Special Packs",
    image: "https://marvel-b1-cdn.bc0a.com/f00000000202513/www.fosterfarms.com/wp-content/uploads/960-72763-450959-RTC-CON-PCNCPCK-25PD_H.png",
  },
];
